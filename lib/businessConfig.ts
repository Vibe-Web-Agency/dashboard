...
export type FeatureKey = "calendar" | "reservations" | "quotes" | "analytics" | "catalog" | "team" | "content";
...
export const ALL_FEATURES: FeatureKey[] = ["calendar", "reservations", "quotes", "analytics", "catalog", "team", "content"];
